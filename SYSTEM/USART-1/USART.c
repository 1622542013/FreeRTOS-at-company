...
uint8_t Usart1Dma_Rec_Buff[BUFSIZE_USART1_REC];
uint8_t Usart1Dma_Main_Buff[BUFSIZE_USART1_SEND];
uint8_t Usart1Dma_Send_Buff[BUFSIZE_USART1_SEND];
#endif
...
uint8_t Usart2Dma_Rec_Buff[BUFSIZE_USART2_REC];
uint8_t Usart2Dma_Main_Buff[BUFSIZE_USART2_SEND];
uint8_t Usart2Dma_Send_Buff[BUFSIZE_USART2_SEND];
#endif
...
uint8_t Usart3Dma_Rec_Buff[BUFSIZE_USART3_REC];
uint8_t Usart3Dma_Main_Buff[BUFSIZE_USART3_SEND];
uint8_t Usart3Dma_Send_Buff[BUFSIZE_USART3_SEND];
#endif
...
uint8_t Usart4Dma_Rec_Buff[BUFSIZE_USART4_REC];
uint8_t Usart4Dma_Main_Buff[BUFSIZE_USART4_SEND];
uint8_t Usart4Dma_Send_Buff[BUFSIZE_USART4_SEND];
#endif
...
uint8_t Usart5Dma_Rec_Buff[BUFSIZE_USART5_REC];
uint8_t Usart5Dma_Main_Buff[BUFSIZE_USART5_SEND];
uint8_t Usart5Dma_Send_Buff[BUFSIZE_USART5_SEND];
#endif
...
uint8_t Usart6Dma_Rec_Buff[BUFSIZE_USART6_REC];
uint8_t Usart6Dma_Main_Buff[BUFSIZE_USART6_SEND];
uint8_t Usart6Dma_Send_Buff[BUFSIZE_USART6_SEND];
#endif
...
{ 
	...
	switch(pu->index)
	{
		...
		case USART_1:
           ...
           pu->cb.rec_buf = Usart1Dma_Rec_Buff;
           pu->cb.send_buf = Usart1Dma_Main_Buff;
	         pu->cb.main_buf = Usart1Dma_Send_Buff;
				}
				break;
#endif
		...
		case USART_2:
           ...
           pu->cb.rec_buf = Usart2Dma_Rec_Buff;
           pu->cb.send_buf = Usart2Dma_Main_Buff;
	         pu->cb.main_buf = Usart2Dma_Send_Buff;
				}
				break;
#endif	
		...
		case USART_3:
           ...
           pu->cb.rec_buf = Usart3Dma_Rec_Buff;
           pu->cb.send_buf = Usart3Dma_Main_Buff;
	         pu->cb.main_buf = Usart3Dma_Send_Buff;
				}
				break;
#endif	
		...
		case USART_4:
           ...
           pu->cb.rec_buf = Usart4Dma_Rec_Buff;
           pu->cb.send_buf = Usart4Dma_Main_Buff;
	         pu->cb.main_buf = Usart4Dma_Send_Buff;
				}
				break;			
#endif	
		...
		case USART_5:
           ...
           pu->cb.rec_buf = Usart5Dma_Rec_Buff;
           pu->cb.send_buf = Usart5Dma_Main_Buff;
	         pu->cb.main_buf = Usart5Dma_Send_Buff;
				}
				break;			
#endif
		...
		case USART_6:
           ...
           pu->cb.rec_buf = Usart6Dma_Rec_Buff;
           pu->cb.send_buf = Usart6Dma_Main_Buff;
	         pu->cb.main_buf = Usart6Dma_Send_Buff;
				}
				break;
#endif
		}
...
TpBool UsartSend(Usart* pu)
{
	...
	SendCom(pu);
		 ...
		 case USART_1:
     {
			 ...
			 if(pu->cb.send_pt)
			 {     
         DMA_ClearFlag(DMA2_Stream7, DMA_FLAG_TCIF6);  /* Clear Pending DMA channel x flag (DMA1 DMA1_Stream6 transfer completion flag) */
         DMA_SetCurrDataCounter(DMA2_Stream7, pu->cb.send_pt);
		 ...
		 case USART_2:
     {
       ...
       //   DMA_Cmd(DMA1_Stream6, DISABLE);
       //   while(DMA_GetCmdStatus(DMA1_Stream6) != DISABLE);
          DMA_SetCurrDataCounter(DMA1_Stream6, pu->cb.send_pt);
...
TpVoid UsartPushSendBuf(Usart* pu,TpUchar* pbuf,TpUint16 len)
{
  ...
  memcpy(&pu->cb.send_buf[pu->cb.send_pt], pbuf, len); /* Copy memory */
...
{  
  memcpy(&pu->cb.main_buf[pu->cb.main_pt], pbuf, len); /* Copy memory */
...
TpVoid SendCom(Usart* pu)
{
  ...
  if(pu->cb.main_pt > 1)
  {
    memcpy(&pu->cb.send_buf[pu->cb.send_pt], pu->cb.main_buf, pu->cb.main_pt); /* Copy memory */
  }
